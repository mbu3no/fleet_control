...
export function ReservationsView({ vehicles, reservations, openModal, removeItem, updateStatus, getVehicleName }) {
  ...
  return (
    <div>
      <PageHeader title="Reservas" count={reservations.length} onAdd={vehicles.length > 0 ? () => openModal('reservation') : null} />
